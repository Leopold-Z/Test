...
namespace SpatialQueryAndAnalysis
{
    ...
    [ProgId("SpatialQueryAndAnalysis.OpenAttributeTableCmd")]
    public sealed class OpenAttributeTableCmd : BaseCommand
    {
        ...
        public override void OnClick()
        {
            ...
            if (map == null) return;
            SpatialQueryAndAnalysis.AttributesContextMenu layerAttributeTable = new SpatialQueryAndAnalysis.AttributesContextMenu(map, currentLayer);
